...
T.Menu
{
    ...
    background: HeeraUI.RoundedRect {
        opacity: 1.0
    ...
    T.Overlay.modal: Rectangle  {
        color: Qt.rgba( control.HeeraUI.Theme.primaryBackgroundColor.r,
                        control.HeeraUI.Theme.primaryBackgroundColor.g,
                        control.HeeraUI.Theme.primaryBackgroundColor.b, 0.4)
        Behavior on opacity {
            NumberAnimation {
                duration: 150
                easing.type: Easing.InOutCubic
