...
T.Slider {
    ...
    handle: Rectangle {
        ...
        width: HeeraUI.Units.iconSizes.medium
        height: width
        radius: width / 2
        color: "white"
        opacity: 1
        border.color: Qt.rgba(HeeraUI.Theme.textColor.r,
                              HeeraUI.Theme.textColor.g,
                              HeeraUI.Theme.textColor.b, 0.1)
    ...
    background: Item {
        ...
        Rectangle {
            ...
            color: HeeraUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.5) : Qt.rgba(0, 0, 0, 0.15)
        }
